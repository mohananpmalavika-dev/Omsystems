...
export class IncidentCorrelationService {
  ...
  private generateIncidentTitle(event: DetectionEvent, count: number): string {
    const typeMap: Record<string, string> = {
      ...
      'atm-abnormal-activity': 'ATM Abnormal Activity Detected',
      'door-forced': 'Door Forced Open Alert',
      'door-held-open': 'Door Held Open Alert',
      'access-denied': 'Access Denied Breach Attempt',
      'blocked-vehicle': 'Blocked Watchlist Vehicle Detected',
      'vehicle-watchlist-match': 'Watchlist Vehicle Match Detected',
      'after-hours-person': 'After-Hours Intrusion Detected',
      'employee-only-zone': 'Employee-Only Zone Violation',
      'restricted-multiple-person': 'Multiple-Person Restricted Entry',
      'multi-camera-cluster': 'Multi-Camera Cross-Tracking Incident',
