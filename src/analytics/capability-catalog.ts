...
export const AI_CAPABILITY_DOMAINS: AiCapabilityDomain[] = [
  ...
  { id: "prediction", name: "AI prediction", description: "Failure, capacity, interruption, and branch-risk forecasts", capabilities: [
    ...
    // Predictive Security Intelligence ("SecurityGPT")
    c("behavioral-pattern-learning", "Behavioral pattern learning", "derived"), 
    c("behavioral-baseline", "Behavioral baseline profiling", "derived"),
    c("behavioral-anomaly-detection", "Behavioral anomaly detection", "derived", "P2"),
    c("statistical-anomaly-detection", "Statistical anomaly detection", "derived"),
    c("temporal-anomaly-detection", "Temporal anomaly detection", "derived"),
    c("spatial-anomaly-detection", "Spatial anomaly detection", "derived"),
    c("security-risk-heatmap", "Security risk heat map", "derived"),
    c("spatial-risk-prediction", "Spatial risk prediction", "derived"),
    c("temporal-risk-prediction", "Temporal risk prediction", "derived"),
    c("incident-prediction-24h", "24-hour incident prediction", "derived", "P2"),
    c("incident-prediction-48h", "48-hour incident prediction", "derived"),
    c("incident-prediction-72h", "72-hour incident prediction", "derived"),
    c("intrusion-prediction", "Intrusion prediction", "derived", "P1"),
    c("theft-prediction", "Theft prediction", "derived", "P2"),
    c("violence-prediction", "Violence prediction", "derived", "P1"),
    c("unauthorized-access-prediction", "Unauthorized access prediction", "derived", "P2"),
    c("proactive-patrol-optimization", "Proactive patrol optimization", "derived"),
    c("patrol-route-optimization", "Patrol route optimization", "derived"),
    c("risk-based-patrol-planning", "Risk-based patrol planning", "derived"),
    c("multi-officer-route-planning", "Multi-officer route planning", "derived"),
    c("patrol-effectiveness-tracking", "Patrol effectiveness tracking", "derived"),
    c("security-intelligence-reporting", "Security intelligence reporting", "derived"),
    c("predictive-security-dashboard", "Predictive security dashboard", "derived"),
    c("real-time-risk-updates", "Real-time risk updates", "derived"),
  ]},
