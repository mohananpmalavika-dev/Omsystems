...
export class TailgatingRepository {
  ...
  private seedDefaultPortals(): void {
    const defaultPortal: AirlockPortalRecord = {
      ...
      outer_door_id: 'DOOR-VAULT-OUTER',
      inner_door_id: 'DOOR-VAULT-INNER',
      chamber_zone: [
        { x: 0.2, y: 0.2 },
        { x: 0.8, y: 0.2 },
        { x: 0.8, y: 0.8 },
  ...
  async upsertPortal(portal: Partial<AirlockPortalRecord> & {
    ...
    const newRecord: AirlockPortalRecord = {
      ...
      outer_door_id: portal.outer_door_id,
      inner_door_id: portal.inner_door_id,
      chamber_zone: portal.chamber_zone || [],
