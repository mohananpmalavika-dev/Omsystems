...
export class EdgeFleetManagerService {
  ...
  private seedInitialFleet() {
    ...
    const rel372: EdgeAgentRelease = {
      ...
      platform: "windows",
      architecture: "x64",
      packageUrl: "https://artifacts.sentinelgrid.internal/releases/edge-agent-3.7.2-signed.zip",
      ...
      status: "RELEASED",
      createdBy: "secops-lead@sentinelgrid.io",
      approvedBy: "cso-approver@sentinelgrid.io",
    ...
    const rel371: EdgeAgentRelease = {
      ...
      platform: "windows",
      architecture: "x64",
      packageUrl: "https://artifacts.sentinelgrid.internal/releases/edge-agent-3.7.1-signed.zip",
