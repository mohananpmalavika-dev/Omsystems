...
|---|---|---|---|
| **Sustained Event Throughput** | **4,93,480 events/sec** | >= 5,000 events/sec | **EXCEEDED** |
| **API Latency (p50)** | **0.001 ms** | <= 50.0 ms | **EXCEEDED** |
| **API Latency (p95)** | **0.003 ms** | <= 150.0 ms | **EXCEEDED** |
| **API Latency (p99)** | **0.006 ms** | <= 300.0 ms | **EXCEEDED** |
| **Database Query Throughput** | **3,20,762 queries/sec** | >= 2,000 queries/sec | **PASSED** |
| **Database Query Latency (p95)** | **0.01 ms** | <= 25.0 ms | **PASSED** |
| **Redis Ops Throughput** | **5,92,176 ops/sec** | >= 4,000 ops/sec | **PASSED** |
| **Redis Operation Latency (p95)**| **0 ms** | <= 5.0 ms | **PASSED** |
| **Process Memory (RSS)** | **89 MB** | <= 1,024 MB | **PASSED** |
| **Heap Memory (Used)** | **15 MB** | <= 512 MB | **PASSED** |
| **CPU Utilization (Process)** | **166.6%** | <= 80.0% | **PASSED** |
...
- **Measured Reconnect Time**: **0.23 ms** (Target: < 2,000 ms).
...
- **Measured Alert Dispatch Latency (p95)**: **0.02 ms** (Target: < 2,000 ms).
...
- **Failover Routing Execution Time**: **1.09 ms** (Target: < 500 ms).
