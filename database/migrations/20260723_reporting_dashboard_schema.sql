...
CREATE INDEX IF NOT EXISTS idx_recording_gap_summary_tenant ON recording_gap_summary(tenant_id);
CREATE INDEX IF NOT EXISTS idx_recording_gap_summary_camera ON recording_gap_summary(camera_id, gap_start DESC);
CREATE INDEX IF NOT EXISTS idx_recording_gap_summary_date ON recording_gap_summary(gap_start DESC);
