...
OutputDir=output
OutputBaseFilename=KryptonVisionInstaller-v0.1.28-windows
...
begin
  ...
  if UsePackageConfiguration and not ExistingInstall then begin
    ...
    UpdateConfigSetting('EDGE_AGENT_VERSION', '0.1.28');
  ...
  Config :=
    ...
    'EDGE_AGENT_VERSION="0.1.28"' + #13#10 +
