...
OutputDir=output
OutputBaseFilename=KryptonVisionInstaller-v0.1.32-windows
...
begin
  ...
  if UsePackageConfiguration and not ExistingInstall then begin
    ...
    UpdateConfigSetting('EDGE_AGENT_VERSION', '0.1.32');
  ...
  Config :=
    ...
    'EDGE_AGENT_VERSION="0.1.32"' + #13#10 +
