...
const schema = z.object({
  ...
  EDGE_AGENT_VERSION: z.string().default("0.1.21"),
  ...
  EDGE_CLIENT_CERT_PATH: z.preprocess((value) => value === "" ? undefined : value, z.string().optional()),
  EDGE_CLIENT_KEY: z.preprocess((value) => value === "" ? undefined : value, z.string().optional()),
  EDGE_CLIENT_KEY_PATH: z.preprocess((value) => value === "" ? undefined : value, z.string().optional()),
  EDGE_CA_CERT: z.preprocess((value) => value === "" ? undefined : value, z.string().optional()),
  EDGE_CA_CERT_PATH: z.preprocess((value) => value === "" ? undefined : value, z.string().optional()),
  EDGE_MTLS_REJECT_UNAUTHORIZED: z.enum(["true", "false"]).default("true").transform((value) => value === "true"),
