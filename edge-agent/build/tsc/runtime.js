 ...
 */
export function prepareEdgeRuntime(argv = process.argv.slice(2), environment = process.env) {
    ...
    if (explicitConfig && !configPath)
        throw new Error(`Edge-agent configuration file not found: ${candidates[0]}`);
...
export function hasArgument(argv, name) {
