...
export default function PrivacyPolicyPage() {
  return (
    <main className="legal-page">
      <PageHero eyebrow="Legal" title="Privacy policy" description="How KryptonVision handles account, operational, device, and video-security information." icon={LockKeyhole} />
      <article className="legal-panel">
        <p className="legal-updated">Last updated: August 10, 2026</p>
        <LegalSection title="Information handled">KryptonVision may process account identifiers, organization and branch configuration, device telemetry, audit activity, incidents, evidence metadata, and video-security records configured by your organization.</LegalSection>
