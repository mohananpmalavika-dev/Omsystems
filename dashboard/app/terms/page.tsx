...
export default function TermsPage() {
  return (
    <main className="legal-page">
      <PageHero eyebrow="Legal" title="Terms of service" description="The operating terms for authorized use of KryptonVision." icon={FileText} />
      <article className="legal-panel">
        <p className="legal-updated">Last updated: August 10, 2026</p>
        <LegalSection title="Authorized use">Use KryptonVision only through an account and organization you are authorized to access. Operators must follow applicable law, organizational policy, retention requirements, and camera-surveillance rules.</LegalSection>
