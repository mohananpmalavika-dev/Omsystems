export const roleWorkspacePaths: Record<string, string[]> = {
  operator: ["/nbfc-operations", "/role-dashboard", "/", "/control-room", "/operations/alerts", "/analytics/alerts", "/incidents", "/video-search", "/playback/synced", "/recordings", "/operations/storage", "/operations/cameras", "/operations/recording"],
  security_officer: ["/nbfc-operations", "/role-dashboard", "/", "/control-room", "/operations/alerts", "/analytics/alerts", "/incidents", "/video-search", "/playback/synced", "/evidence", "/analytics/anpr-logistics", "/analytics/nbfc-watchlist", "/security/device-health", "/analytics/banking", "/operations/storage", "/operations/cameras", "/operations/recording", "/recordings"],
  ...
  admin: ["/nbfc-operations", "/role-dashboard", "/", "/analytics/alerts", "/operations/storage", "/operations/cameras", "/operations/recording", "/recordings", "/admin/organization", "/admin/organization?tab=hierarchy", "/admin/organization?tab=employees", "/admin/organization?tab=roles", "/admin/branch-onboarding", "/admin/zero-touch", "/maintenance/device-configuration", "/maintenance/device-management", "/integrations", "/admin/system", "/account/security", "/analytics/anpr-logistics", "/analytics/nbfc-watchlist", "/security/device-health", "/analytics/branch-comparison", "/analytics/banking"],
};
