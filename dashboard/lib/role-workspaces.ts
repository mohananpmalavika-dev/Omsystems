export const roleWorkspacePaths: Record<string, string[]> = {
  ...
  admin: ["/nbfc-operations", "/role-dashboard", "/", "/analytics/alerts", "/admin/organization?tab=hierarchy", "/admin/organization?tab=employees", "/admin/organization?tab=roles", "/admin/branch-onboarding", "/admin/zero-touch", "/maintenance/device-configuration", "/maintenance/device-management", "/integrations", "/admin/system", "/account/security", "/analytics/anpr-logistics", "/analytics/nbfc-watchlist", "/security/device-health", "/analytics/branch-comparison", "/analytics/banking"],
};
