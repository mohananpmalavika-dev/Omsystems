...
export const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "My Operations Dashboard", href: "/role-dashboard", icon: BarChart3 },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "High Availability", href: "/operations/ha-failover", icon: Server },
      { label: "Edge Agent Management", href: "/operations/edge-fleet", icon: Server },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Recorder Health", href: "/maintenance/dvr-nvr-monitor", icon: Server },
      ...
      { label: "Recover Recording Gaps", href: "/operations/recording/recovery", icon: RefreshCw },
      { label: "Archive Storage", href: "/operations/recording/archive", icon: Snowflake },
      ...
      { label: "Run Health Checks", href: "/maintenance/health", icon: Gauge },
      { label: "Maintenance Alerts", href: "/maintenance/alerts", icon: AlertTriangle },
      { label: "Connection Diagnostics", href: "/diagnostics", icon: Gauge },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Vehicle Analytics", href: "/analytics/vehicles", icon: CarFront },
      ...
      { label: "Camera Tamper & Defocus", href: "/analytics/camera-tamper", icon: EyeOff },
      { label: "Camera Obstruction & Dark Frame", href: "/analytics/camera-obstruction", icon: ShieldAlert },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Privacy Processing Purposes", href: "/maintenance/privacy/purposes", icon: FileText },
      { label: "Privacy Control Policies", href: "/maintenance/privacy/controls", icon: ShieldCheck },
  ...
  },
  {
    ...
    icon: FileText,
    items: [
      { label: "Executive Dashboard (NEW)", href: "/mis-dashboard", icon: LayoutDashboard },
      { label: "Financial TCO & ROI (NEW)", href: "/reports/financial", icon: TrendingUp },
      { label: "Branch Benchmarking (NEW)", href: "/reports/benchmarking", icon: BarChart3 },
      { label: "Compliance Scorecard (NEW)", href: "/reports/compliance", icon: ShieldCheck },
      { label: "Executive MIS Reports & Graphs", href: "/reports/mis", icon: FileSpreadsheet },
