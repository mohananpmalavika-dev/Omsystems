...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    icon: HeartPulse,
    items: [
      { label: "Camera 7-Layer Health", href: "/operations/cameras", icon: Camera },
      { label: "Recorders & NVR", href: "/maintenance/dvr-nvr-monitor", icon: Server },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Evidence & Investigations", href: "/evidence", icon: FileCheck2 },
      { label: "Digital Twin (Topology)", href: "/digital-twin", icon: Boxes },
      { label: "Root-Cause Analysis", href: "/operations/rca-analysis", icon: FileSearch },
      { label: "Predictive Health", href: "/maintenance/predictive", icon: TrendingUp },
    ],
  },
  {
    label: "REPORTING",
    ...
    items: [
      ...
      { label: "Activity Audit Logs", href: "/activity-report", icon: UserRoundCog },
  ...
  },
  {
    ...
    icon: UserRoundCog,
    items: [
      { label: "Organization & Structure", href: "/admin", icon: Building2 },
      { label: "Employees & Permissions", href: "/admin?tab=users", icon: Users },
      { label: "Branch Onboarding", href: "/admin/branch-onboarding", icon: Building2, badge: "cameras" },
      { label: "AI Quality & Models", href: "/admin/ai-quality", icon: Sparkles },
      ...
      { label: "Compliance Policies", href: "/compliance", icon: ShieldCheck },
      { label: "System Management", href: "/admin/system", icon: Settings },
      { label: "Account & Security", href: "/account/security", icon: LockKeyhole },
    ],
  },
];
