...
export const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Media Pipeline & HA", href: "/operations/media-pipeline", icon: Layers },
    ],
  },
  {
    label: "INTELLIGENCE",
    icon: Sparkles,
    items: [
      { label: "AI Investigation & Search", href: "/video-search", icon: Search },
      { label: "Predictive Health & RCA", href: "/maintenance/predictive", icon: TrendingUp },
      { label: "Root-Cause Analysis", href: "/operations/rca-analysis", icon: FileSearch },
      { label: "AI Assistant Command", href: "/operations/ai-command-center", icon: Command },
      { label: "Digital Twin (3D)", href: "/digital-twin", icon: Boxes },
    ],
  },
  {
    label: "ANALYTICS",
    icon: Activity,
    items: [
      { label: "Safety & Compliance", href: "/compliance", icon: ShieldCheck },
      { label: "People Counting & Heatmaps", href: "/analytics/people", icon: Users },
      { label: "Vehicles & ANPR Telemetry", href: "/analytics/anpr", icon: CarFront },
      { label: "Banking & Retail Operations", href: "/analytics/banking", icon: Landmark },
  ...
  },
  {
    ...
    icon: Settings,
    items: [
      { label: "Users & Access Control", href: "/admin?tab=users", icon: Users },
      { label: "Security & Governance", href: "/account/security", icon: LockKeyhole },
      { label: "Hardware Registry & Lab", href: "/maintenance/compatibility", icon: SlidersHorizontal },
      { label: "Integrations & API", href: "/integrations", icon: Workflow },
      { label: "System & Audit Logs", href: "/activity-report", icon: Settings },
    ],
  },
];
