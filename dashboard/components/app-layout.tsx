...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Gap Recovery & Backfill", href: "/operations/recording/recovery", icon: RefreshCw },
      { label: "Cold Cloud Archive", href: "/operations/recording/archive", icon: Snowflake },
