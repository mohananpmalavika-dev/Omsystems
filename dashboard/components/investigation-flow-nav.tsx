...
const workflow: WorkflowStep[] = [
  { label: "Live coverage", href: "/control-room", icon: MonitorPlay },
  { label: "Find video", href: "/video-search", icon: Search },
  { label: "Review", href: "/playback/synced", icon: Play },
  { label: "Recording", href: "/recordings", icon: FileVideo2 },
  ...
  return (
    <nav className="investigation-flow" aria-label="Surveillance investigation workflow">
      <div className="investigation-flow-context">
        <span>24×7 protection &amp; proof</span>
        <p>Protect every branch, investigate fast, preserve proof</p>
      </div>
