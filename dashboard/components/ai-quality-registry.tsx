                ...
                <div key={det.detectorId} className="bg-slate-950 border border-slate-800 rounded-lg p-4 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-6 font-mono text-xs">
                    ...
                    <div className="text-right">
                      ...
                      <p className={(det.driftPercentage ?? 0) > 25 ? "text-amber-400 font-bold" : "text-emerald-400 font-bold"}>
                        {det.driftPercentage == null ? "Not measured" : det.driftPercentage > 0 ? `+${det.driftPercentage}%` : `${det.driftPercentage}%`}
                      </p>
                    </div>
                  </div>
                </div>
