/**
 * First-Class Branch Internet & WAN Connectivity Domain Models
 */
...
export interface BranchNetworkSla {
  branchId: string;
  period: string; // e.g. "2026-08" or "2026-08-16"
  primaryUptimePct: number;
  backupUptimePct: number;
  effectiveBranchUptimePct: number;
  vpnUptimePct: number;
  failoverCount: number;
  totalFailoverDurationSeconds: number;
